    ...
    <section id="projects">
      <div className="container">
        ...
        <div className="project">
          <h3 className="no-animation">holbertonschool system engineering devops</h3>
        ...
        <div className="project">
          <h3 className="no-animation">holbertonschool AirBnB clone</h3>
        ...
        <div className="project">
          <h3 className="no-animation">holbertonschool AirBnB clone_v2</h3>
        ...
        <div className="project">
          <h3 className="no-animation">Holberton School C Algorithms and Data Structures</h3>
        ...
        <div className="project">
          <h3 className="no-animation">Holberton School Python Algorithms and Data Structures</h3>
        ...
        <div className="project">
          <h3 className="no-animation">InternPulse Project</h3>
